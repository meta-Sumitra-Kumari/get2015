...
/**
 * @author Sumitra --- Servlet implementation class EmployeeDataFetchAndSend This
 *         servlet will fetch data of all employees and send to employee list
 *         page
 *
 */
public class EmployeeDataFetchAndSend extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		getServletContext().getRequestDispatcher("/view/EmployeeListPage.jsp")
