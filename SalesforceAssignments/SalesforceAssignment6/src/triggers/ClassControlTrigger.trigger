trigger ClassControlTrigger on Class__c (before delete) {

 List<Student__c> studentList = [Select id,class__r.id from Student__c where Sex__c='F' AND Class__c In :Trigger.old];
